...
import 'package:flutter_application_2/views/camo/camera_file.dart';
import 'package:flutter_application_2/views/camo/filters.dart';
                ...
                GestureDetector(
                  onTap: () async {
                    ...
                    try {
                      ...
                      Get.off(CameraPreviewScreen(file: file));
